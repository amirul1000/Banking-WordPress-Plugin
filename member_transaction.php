<?php
  ...
  switch($cmd){
    ...
    case "edit":
		  ...
		  break;*/		  
	default:
	   $transaction  = $wpdb->get_results("select * from wp_transaction  WHERE users_id='".get_current_user_id()."'  ORDER BY id DESC"); 
	   include(dirname(__FILE__) . '/template/member/transaction/index.php');  
  }
?>