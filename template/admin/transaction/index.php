...
<div>
	<div class="float_left padding_10">
		<a href="admin.php?page=transaction&cmd=edit"
...
<table cellspacing="3" cellpadding="3" class="table table-striped table-bordered">
    ...
    <tr>
		...
		<td>
            <a href="admin.php?page=transaction&cmd=edit&id=<?=$c->id?>" class="action-icon"> Edit</a>
            <a href="admin.php?page=transaction&cmd=delete&id=<?=$c->id?>" onClick="return confirm('Are you sure to delete this item?');" class="action-icon"> Delete</a>
         </td>
    </tr>
	<?php } ?>
</table>
